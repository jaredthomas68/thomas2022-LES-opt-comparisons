...
function wind_farm_setup(nturbines; case="high-ti", tuning="sowfa-nrel", layoutid=1, nrotorpoints=1, alpha=0, layoutdir="../inputfiles/farms/startinglayouts/angle-each-circle/", lspacing=3.0, basedirs=12)

...
function run_optimization(layoutid, ndirectionbins; case="high-ti", tuning="sowfa-nrel", plotresults=false, verbose=true, wec=true, nrotorpoints=1, alpha=0, savehistory=false, optimize=true, outdir="./", layoutdir="../inputfiles/farms/startinglayouts/angle-each-circle/", lspacing=3.0)
...
function run_optimization_series(nruns, case, tuning, ndirectionbins; outdir="./", layoutgen="angle-each-circle", wec=true, lspacing=3.0, firstrun=1, verbose=false, plotresults=false, savehistory=true)

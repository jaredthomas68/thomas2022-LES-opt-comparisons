...
function run_optimization(layoutid, nrotorpoints; case="high-ti", ndirectionbins=12, tuning="sowfa-nrel", plotresults=false, verbose=true, wec=true, alpha=0, savehistory=false, optimize=true, outdir="./", layoutdir="../inputfiles/farms/startinglayouts/angle-each-circle/", lspacing=3.0)
...
function run_optimization_series(nruns, case, tuning, nrotorpoints; outdir="./", layoutgen="angle-each-circle", wec=true, lspacing=3.0, firstrun=1, verbose=false, ndirectionbins=12, plotresults=false, savehistory=true)
